...
def message_to_sereen(msg,color):
...
def gameLoop():
    ...
    while not gameExit:
        while gameOver == True:
            ...
            message_to_sereen('Game is over,press c to play again q for exit',black)
        ...
        # print([int(randomAppleX),int(randomAppleY),AppleThickness,A])
